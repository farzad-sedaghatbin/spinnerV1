...
mql.matches || $("#alert").removeClass("hide").addClass("visible"), mql.addListener(function (e) {
  ...
  gameLoaded: function () {
    ...
    a.focus(), $(".relatedGames").length && (window.scroller4 = new Scroller("#overlay-end .relatedGames .scrollArea", scrollerConfigHorizontal)), window.scroller5 = new Scroller("#overlay-end .scrollerWrap", scrollerConfigVertical), "undefined" != typeof kik && kik.enabled && kik.getUser(function (e) {
...
$(".re-request-friends-permission").on("click", function (e) {
  ...
  var a = $(this).data("screen"), t = $(this).data("type"), n = $(this).data("version"), o = 1;
  gameeUI.sendMixpanelShare(t, a, n, o)
  ...
  gameeUI.shareLoading.show(), setTimeout(function () {
  ...
  var a = $("body").attr("data-bot-deep-link-base"), t = {
    type: "game",
  ...
  }, n = a + "?ref=" + encodeURIComponent(JSON.stringify(t)), o = {
    attachment: {
      type: "template",
      payload: {
        ...
        elements: [{
          ...
          subtitle: "My score is: " + t.score,
          default_action: {type: "web_url", url: n},
          buttons: [{type: "web_url", url: n, title: "▶ Play " + gameGlobals.game_name}]
        }]
      }
    }
  };
  MessengerExtensions.beginShareFlow(function () {
    ...
    var t = $("body").data("facebook-bot-app-id"), n = gameGlobals.game_fullUrl;
    window.open("fb-messenger://share?link=" + encodeURIComponent(n) + "&app_id=" + encodeURIComponent(t))
  }, o, "broadcast")
...
window.onbeforeunload = function (event) {
  if (confirm("آیا برای خروج اطمینان دارید؟در صورت خروج امتیاز صفر برای شما ثبت می شود.") == true) {
