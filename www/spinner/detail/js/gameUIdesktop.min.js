function transformOverlay(e, a) {
  var t = e.innerWidth(), s = e.innerHeight(), n = $(".b_contentWrap").height(), i = $("body").width(), r = i / 6.4 / 100, o = n / 6.36 / 100;
...
gameeUI.prototype.init = function (e, a) {
  ...
  var a = window.location.pathname, t = (new Date).getTime(), s = $("#dataId").data(), n = CryptoJS.AES.encrypt(JSON.stringify({
    score: e,
    timestamp: t
  }), s.id, {format: CryptoJSAesJson}).toString(), i = {score: e, url: a, play_time: gameeUI.playTime, hash: n};
  if (isFacebook()) {
  ...
  var a = e.result.ranking, t = 0 != Object.keys(a.beforeMe).length ? a.beforeMe : "", s = 0 != Object.keys(a.afterMe).length ? a.afterMe : "", n = a.me, i = "", r = "", o = "", l = 1, c = 1;
  ...
  var a = e.result.ranking, t = 0 != Object.keys(a.beforeMe).length ? a.beforeMe : "", s = 0 != Object.keys(a.afterMe).length ? a.afterMe : "", n = a.me, i = "", r = "", o = 1, l = 1, c = Object.keys(a.beforeMe).length + Object.keys(a.afterMe).length + 1;
  ...
  for (var n in a) {
    var i = a[n].rank === t ? "me" : "", r = '<div class="avatar"><img src="' + addProfilePicture(a[n].profile_picture) + '" class="pic" /></div>';
