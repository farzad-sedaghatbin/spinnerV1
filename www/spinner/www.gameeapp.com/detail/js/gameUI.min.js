...
mql.matches || $("#alert").removeClass("hide").addClass("visible"), mql.addListener(function (e) {
  ...
  gameLoaded: function () {
    ...
    e.addClass("loaded"), gameeUI.startOverlay.show(), a.focus(), "undefined" != typeof kik && kik.enabled && kik.getUser(function (e) {
            ...
            tx.executeSql('UPDATE MYGAME SET val=? WHERE name= "score"', [a.join(",")], function (tx, results) {
              tx.executeSql('DELETE FROM MYGAME WHERE name="wasInGame"', [], function (tx, results) {
                tx.executeSql('INSERT INTO MYGAME (name, val) VALUES (?, ?)', ["wasInGame", true],function (tx, results) {
                  $("#overlay-end .rankings, #overlay-end .ranks-wrap").removeClass("visible"), $(".share-tw").attr("href", gameeUI.game_tw_link(e)), gameeUI.currentState = "gameOver", gameeUI.highscoreBeat = !1, gameeUI.setScoreCustomText("Good job"), $(".relatedGames").length && (window.scroller4 = new Scroller("#overlay-end .relatedGames .scrollArea", scrollerConfigHorizontal)), gameeUI.overlay.show(), gameeUI.controls.hide(), setTimeout(function () {
  ...
  updateHighscore: function (e) {
    gameeUI.score > gameeUI.gameHighscore ? (gameeUI.gameHighscore = e, gameeUI.firstPlay = !1, gameeUI.setScoreMessage("New highscore")) : gameeUI.setScoreMessage("You scored")
  },
