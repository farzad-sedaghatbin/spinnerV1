!function (e) {
  ...
  var i = n(0), s = document.getElementById("game-wrapper"), a = document.getElementById("overlay-wrapper"), r = document.getElementById("game-overlay"), d = (t.resetAll = function () {
    ...
    p2.className = "button-collect button-large";
    var p3 = document.createElement("button");
    p3.className = "button-collect button-large";
    ...
    return h.className = "coin-icon", u.appendChild(h), u.appendChild(l), u.appendChild(p), u.appendChild(p2), u.appendChild(p3), e.appendChild(u), {
    ...
    e1.className = "upgrade-screen ui-text";
    var t1 = document.createElement("div");
    t1.className = "close-button", t1.addEventListener("click", function () {
      a.style.display = "none", r.style.display = "none", e.style.display = "none";
      var t1 = o.getWrapper();
      s.appendChild(t1)
    }), e1.appendChild(t1);
    var n1 = document.createElement("p");
    n1.className = "font-70 upgrade-header", n1.innerText = "UPGRADES", e1.appendChild(n1);
    for (var i = ["more speed", "longer spins", "time reward"], d = ["coin.png", "coin.png", "coin.png"], c = [], l = [], p1 = [], u = 0; u < i.length; u++) {
      var h1 = document.createElement("span");
      h1.className = "font-40 upgrade-text", h1.innerText = i[u];
      var m1 = document.createElement("img");
      m1.src = "assets/ui/" + d[u];
      var v1 = document.createElement("span");
      v1.className = "upgrade-level-wrapper font-60";
      var g1 = document.createElement("span");
      g1.className = "upgrade-level", l.push(g1), v1.appendChild(document.createTextNode(" ")), v1.appendChild(g1);
      var f1 = document.createElement("button");
      f1.className = "button-upgrade button-large";
      document.createElement("span").className = "coin-icon";
      var _ = document.createTextNode("");
      f1.appendChild(_), c.push(_), p1.push(f1);
      var b1 = document.createElement("div");
      b1.className = "font-white", b1.className = "button-upgrade-wrapper", b1.appendChild(h1), b1.appendChild(document.createElement("br")), b1.appendChild(m1), b1.appendChild(v1), b1.appendChild(f1), e1.appendChild(b1)
    }
    var m2 = document.createElement("div");
    m2.className = "upgrade-ico";
    m2.style.top = "261px";
    m2.style.zIndex = "100";
    m2.addEventListener("click", function () {
      a.innerHTML = "";
      var t = o.getWrapper();
      a.appendChild(t1), a.appendChild(e1), a.style.display = "block", r.style.display = "block", e1.style.display = "block"
    }, !1);
    s.appendChild(m2);
    var m = document.createElement("div");
    return m.className = "upgrade-ico", m.addEventListener("click", function () {
      a.innerHTML = "";
      var t = o.getWrapper();
      a.appendChild(t), a.appendChild(e), a.style.display = "block", r.style.display = "block", e.style.display = "block"
    }, !1), s.appendChild(m), {
