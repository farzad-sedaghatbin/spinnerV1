...
{   
    ...
    {       
        // Controller        
        var controller = gamee.controller.requestController('FiveButtons');
        
        controller.buttons.left.on('keydown', function() { gmCallback.gamee_onKeyPress(2); });
        controller.buttons.right.on('keydown', function() { gmCallback.gamee_onKeyPress(0); });
        controller.buttons.up.on('keydown', function() { gmCallback.gamee_onKeyPress(1); });
        controller.buttons.down.on('keydown', function() { gmCallback.gamee_onKeyPress(3); });     
