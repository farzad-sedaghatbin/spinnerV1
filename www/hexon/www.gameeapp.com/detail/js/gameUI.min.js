...
function transformOverlay(e, a) {
  var n = e.innerWidth(), s = e.innerHeight(), t = $("#canvasWrap").height(), o = $("#gameeFrameMobile").width(), r = o / 6.8 / 100, i = t / 5.36 / 100;
  a && (r = Math.min(r, i), i = r);
  var l = Math.round((o - n) / 2);
  Math.round((t - s) / 2 - 50);
  e.css({
    "-webkit-transform": "translate(" + l + "px, 0) scale3d(" + r + ", " + i + ", 1)",
    transform: " translate(" + l + "px, 0) scale3d(" + r + ", " + i + ", 1)"
  })
}
function transformElement(e) {
  var a = e.innerWidth(), s = (e.innerHeight(), $("#canvasWrap").height()), t = $("#gameeFrameMobile").width(), o = t / 6.8 / 100, r = s / 5.36 / 100, i = Math.round((t - a) / 2);
  o = Math.min(o, r), r = o, e.css({
    "-webkit-transform": "translateX(" + i + "px) scale3d(" + o + ", " + r + ", 1)",
    transform: " translateX(" + i + "px) scale3d(" + o + ", " + r + ", 1)"
  })
}
function transformControls(e, a) {
  var n = $("#controller"), s = e.innerWidth(), t = e.innerHeight(), o = (s - 190) / 2.7 / 100, r = t / 2.7 / 100;
  a && (o = Math.min(o, r), r = o), n.css({
    "-webkit-transform": "scale3d(" + o + ", " + r + ", 1)",
    transform: "scale3d(" + o + ", " + r + ", 1)"
  })
}
function transformControls2(e, a) {
  var n = $("#restart"), s = $("#play"), t = $("#control-resume"), o = $(".gameLoading"), r = e.innerWidth(), i = e.innerHeight(), l = r / 2 / 100, c = i / 1.52 / 100;
  a && (l = Math.min(l, c), c = l), l >= 1 && (l = 1, c = 1), n.css({
    ...
    "-webkit-transform": "scale3d(" + l + ", " + c + ", 1)",
    transform: "scale3d(" + l + ", " + c + ", 1)"
  }), o.css({"-webkit-transform": "scale3d(" + l + ", " + c + ", 1)", transform: "scale3d(" + l + ", " + c + ", 1)"})
}
function resizeElements(e, a) {
  var n = document.getElementById("gameeFrameMobile"), s = document.getElementById("canvasWrap"), t = document.getElementById("controls"), o = $(".overlay .inner"), r = $("#overlay-end"), i = $("#overlay-start"), l = $("#overlay-pause");
  o.css("max-width", e + "px"), r.css("height", a + "px"), i.css("height", a + "px"), l.css("height", a + "px"), n.width = e, n.height = e, n.style.width = e + "px", n.style.height = e + "px", s.style.height = e + "px", s.style.width = e + "px", t.style.height = a - e + "px", transformOverlay($("#overlay-start .transform"), !0), transformOverlay($("#overlay-end .transform"), !0), transformOverlay($("#overlay-pause .transform"), !0), transformElement($(".transform_score")), transformControls($("#controls"), !0), transformControls2($("#controls"), !0)
}
...
mql.matches || $("#alert").removeClass("hide").addClass("visible"), mql.addListener(function (e) {
      ...
      tx.executeSql('SELECT d.val FROM MYGAME d WHERE d.name="score"', [], function (tx, results) {
        ...
        if (results.rows && results.rows.length != 0) {
          ...
          if (a[0] == "false") {
            ...
            tx.executeSql('UPDATE MYGAME SET val=? WHERE name= "score"', [a.join(",")], function (tx, results) {
              tx.executeSql('DELETE FROM MYGAME WHERE name="wasInGame"', [], function (tx, results) {
                tx.executeSql('INSERT INTO MYGAME (name, val) VALUES (?, ?)', ["wasInGame", true],function (tx, results) {
                  ...
                  }, 500), gameeUI.saveScore(gameeUI.score), gameeUI.updateHighscore(gameeUI.score), gameeUI.sendMixpanel(window.gameeUI.score),  gameeUI.timer.stop(),$("#control-restart").css("display","none")
                });
              });
            });
          } else {
            gameeUI.gameplayCount++, window.scroller5 && window.scroller5.scrollToTop(), $("#overlay-end .rankings, #overlay-end .ranks-wrap").removeClass("visible"), gameeUI.currentState = "gameOver", gameeUI.highscoreBeat = !1, gameeUI.onboardingComplete = !0, gameeUI.setScoreCustomText(""), gameeUI.overlay.show(), gameeUI.controls.hide(), $(".rankingsFailed").hide(), setTimeout(function () {
              gameeUI.restartBtn.show()
            }, 500), gameeUI.saveScore(gameeUI.score), gameeUI.updateHighscore(gameeUI.score), gameeUI.sendMixpanel(window.gameeUI.score),  gameeUI.timer.stop()
          }
        }
      });
    });
  ...
  updateHighscore: function (e) {
    gameeUI.score > gameeUI.gameHighscore ? (gameeUI.gameHighscore = e, gameeUI.firstPlay = !1, gameeUI.setScoreMessage(loc.newHighscore)) : gameeUI.setScoreMessage(loc.youScored)
  },
