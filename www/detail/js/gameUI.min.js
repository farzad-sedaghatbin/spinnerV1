...
gameeUI = {
  ...
  gameLoaded: function () {
    ...
    var db = openDatabase('MySpinner', '1.0', 'SpinnerDB', 1024 * 1024);
    db.transaction(function (tx) {
      tx.executeSql('CREATE TABLE IF NOT EXISTS SPINNER (name , val)');
      tx.executeSql('SELECT d.val FROM SPINNER d WHERE d.name="username"', [], function (tx, results) {
  ...
  game_tw_link: function (i) {
    return "https://twitter.com/share?text=Attention%20please,%20I%20have%20just%20scored%20" + i + "%20in%20" + gameGlobals.game_name + "!%20%40gameeapp%20&url=" + gameGlobals.game_url
  },
