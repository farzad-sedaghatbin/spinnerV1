...
mql.matches || $("#alert").removeClass("hide").addClass("visible"), mql.addListener(function (e) {
  ...
  gameLoaded: function () {
    var e = $("html");
    $(".gameFrame");
    e.addClass("loaded"), gameeUI.startOverlay.show(), $(".relatedGames").length && (window.scroller4 = new Scroller("#overlay-end .relatedGames .scrollArea", scrollerConfigRelatedGames)), window.scroller5 = new Scroller("#overlay-end .scrollerWrap", scrollerConfigVertical), (!isBot() || isWhatsapp()) && (window.scroller6 = new Scroller("#overlay-start .scrollerWrap", scrollerConfigVertical)), isIos() && isTelegram() && $('.tab-link[data-href="subscribe"]').addClass("hidden"), $(".tab-link .badge").hide(), isAndroid() && isTelegram() && !gameGlobals.offerTelegramSubscription && ($('.tab-link[data-href="subscribe"]').addClass("hidden"), $('.tab-link[data-href="community"]').removeClass("hidden"), $(".tab-link .badge").hide()), isFacebook() && ($('.tab-link[data-href="subscribe"]').addClass("hidden"), $('.tab-link[data-href="community"]').removeClass("hidden"), $(".tab-link .badge").hide()), isIos() && $(".subscribe-cover").addClass("ios"), isAndroid() && $(".subscribe-cover").addClass("android"), "undefined" != typeof kik && kik.enabled && kik.getUser(function (e) {
      e ? (gameeUI.user = e.username, gameeUI.getStats()) : (gameeUI.user = null, kik.getAnonymousUser(function (e) {
        gameeUI.anonymous_id = e
      }))
    }), (isTelegram() || isFacebook() || isViber()) && gameeUI.getStats()
  },
  init: function (e, a) {
