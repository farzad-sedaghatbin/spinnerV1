function transformOverlay(e, a) {
  var n = e.innerWidth(), s = e.innerHeight(), t = $("#canvasWrap").height(), r = $("#gameeFrameMobile").width(),
    o = r / 6.8 / 100, i = t / 5.36 / 100;
...
function transformElement(e) {
  var a = e.innerWidth(), s = (e.innerHeight(), $("#canvasWrap").height()), t = $("#gameeFrameMobile").width(),
    r = t / 6.8 / 100, o = s / 5.36 / 100, i = Math.round((t - a) / 2);
...
function transformControls2(e, a) {
  var n = $("#restart"), s = $("#play"), t = $("#control-resume"), r = $(".gameLoading"), o = e.innerWidth(),
    i = e.innerHeight(), l = o / 2 / 100, c = i / 1.52 / 100;
...
function resizeElements(e, a) {
  var n = document.getElementById("gameeFrameMobile"), s = document.getElementById("canvasWrap"),
    t = document.getElementById("controls"), r = $(".overlay .inner"), o = $("#overlay-end"), i = $("#overlay-start");
...
mql.matches || $("#alert").removeClass("hide").addClass("visible"), mql.addListener(function (e) {
  ...
  gameOver: function () {
    parseInt($(".totalScore").html());
    gameeUI.currentState = "gameOver", gameeUI.timer.stop(), gameeUI.gameplayCount++, gameeUI.updateHighscore(gameeUI.score), gameeUI.highscoreBeat = !1, gameeUI.onboardingComplete = !0, $(".tab-link", "#overlay-end").removeClass("active"), $('.tab-link[data-href="rankings"]', "#overlay-end").addClass("active"), $(".tab", "#overlay-end").removeClass("visible"), $(".tab-rankings", "#overlay-end").addClass("visible"), isTelegram() && (gameGlobals.offerTelegramSubscription && gameeUI.gameplayCount % gameeUI.offerSubscriptionIn === 0 || "GIs8lS" == gameGlobals.game_code && "www-devel.gameeapp.com" === window.location.hostname && isIos()), window.scroller5 && window.scroller5.scrollToTop(), $("#overlay-end .rankings, #overlay-end .ranks-wrap").removeClass("visible"), $(".rankingsFailed").hide(), gameeUI.overlay.show(), gameeUI.controls.hide(), setTimeout(function () {
      gameeUI.restartBtn.show()
    }, 500), gameeUI.allowReplay = !1, setTimeout(function () {
      gameeUI.allowReplay = !0
    }, 520), setTimeout(function () {
      gameeUI.saveScore(gameeUI.score)
    }, 100), isBot() && gameeUI.gameHighscore > 0 && ($(".myCurrentScore", ".rankings").html(gameeUI.gameHighscore), $(".yourHighscore", ".rankings").show()), isTelegram() || gameeUI.sendMixpanel(window.gameeUI.score), gameeUI.changeRank && (isViber() || isFacebook() || isWhatsapp()) && gameeUI.beatenDialog.show(), ga("send", {
      hitType: "event",
      eventCategory: "Game",
      eventAction: "Played",
  ...
  checkRankStatus: function (e) {
    var r, a = gameeUI.gameHighscore, n = $(".rankStatus"), s = $(".inner", ".rankStatus"),
      t = '<div class="highscore"><span class="ic"></span> ' + loc.highscoreBeat + "</div>", o = gameeUI.highscoreBeat,
      i = gameeUI.allRankings, l = i.length - 1;
...
$(".re-request-friends-permission").on("click", function (e) {
  ...
  }, s = a + "?ref=" + encodeURIComponent(JSON.stringify(n)), t = {
    attachment: {
      type: "template",
      payload: {
        ...
        elements: [{
          ...
          default_action: {type: "web_url", url: s},
          buttons: [{type: "web_url", url: s, title: "▶ PLAY NOW"}]
        }]
      }
    }
  };
