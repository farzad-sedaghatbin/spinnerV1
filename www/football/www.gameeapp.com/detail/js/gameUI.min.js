...
function transformOverlay(e, a) {
  var t = e.innerWidth(), n = e.innerHeight(), o = $("#canvasWrap").height(), i = $("#gameeFrameMobile").width(), s = i / 6.8 / 100, r = o / 5.36 / 100;
  a && (s = Math.min(s, r), r = s);
  var l = Math.round((i - t) / 2);
  Math.round((o - n) / 2 - 50);
  e.css({
    "-webkit-transform": "translate(" + l + "px, 0) scale3d(" + s + ", " + r + ", 1)",
    transform: " translate(" + l + "px, 0) scale3d(" + s + ", " + r + ", 1)"
  })
}
function transformElement(e) {
  var a = e.innerWidth(), n = (e.innerHeight(), $("#canvasWrap").height()), o = $("#gameeFrameMobile").width(), i = o / 6.8 / 100, s = n / 5.36 / 100, r = Math.round((o - a) / 2);
  i = Math.min(i, s), s = i, e.css({
    "-webkit-transform": "translateX(" + r + "px) scale3d(" + i + ", " + s + ", 1)",
    transform: " translateX(" + r + "px) scale3d(" + i + ", " + s + ", 1)"
  })
}
function transformControls(e, a) {
  var t = $("#controller"), n = e.innerWidth(), o = e.innerHeight(), i = (n - 190) / 2.7 / 100, s = o / 2.7 / 100;
  a && (i = Math.min(i, s), s = i), t.css({
    "-webkit-transform": "scale3d(" + i + ", " + s + ", 1)",
    transform: "scale3d(" + i + ", " + s + ", 1)"
  })
}
function transformControls2(e, a) {
  var t = $("#restart"), n = $("#play"), o = $("#control-resume"), i = $(".gameLoading"), s = e.innerWidth(), r = e.innerHeight(), l = s / 2 / 100, c = r / 1.52 / 100;
  a && (l = Math.min(l, c), c = l), l >= 1 && (l = 1, c = 1), t.css({
    ...
    "-webkit-transform": "scale3d(" + l + ", " + c + ", 1)",
    transform: "scale3d(" + l + ", " + c + ", 1)"
  }), i.css({"-webkit-transform": "scale3d(" + l + ", " + c + ", 1)", transform: "scale3d(" + l + ", " + c + ", 1)"})
}
function resizeElements(e, a) {
  var t = document.getElementById("gameeFrameMobile"), n = document.getElementById("canvasWrap"), o = document.getElementById("controls"), i = $(".overlay .inner"), s = $("#overlay-end"), r = $("#overlay-start"), l = $("#overlay-pause");
  i.css("max-width", e + "px"), s.css("height", a + "px"), r.css("height", a + "px"), l.css("height", a + "px"), t.width = e, t.height = e, t.style.width = e + "px", t.style.height = e + "px", n.style.height = e + "px", n.style.width = e + "px", o.style.height = a - e + "px", transformOverlay($("#overlay-start .transform"), !0), transformOverlay($("#overlay-end .transform"), !0), transformOverlay($("#overlay-pause .transform"), !0), transformElement($(".transform_score")), transformControls($("#controls"), !0), transformControls2($("#controls"), !0)
}
...
var Game = {}, GameeBridge = {}, gameeUI = {}, timer, loc = window.localization;
window.scrollerConfigHorizontal = {
  ...
  a.attr("src", a.data("src")), Game = gameeGame(e[0]), Game2 = gamee2Game(e[0], gameeUI), gameeUI.gameLoader.show(), gameeUI.playBtn.hide(), "tw" === webviewProvider && $(".share-fb").remove(), "fb" === webviewProvider && $(".share-tw").remove(), $(".cRankingsBtn").on("click", function (e) {
...
mql.matches || $("#alert").removeClass("hide").addClass("visible"), mql.addListener(function (e) {
  ...
  myPhoto: null,
  gameplayCount: 0,
  offerSubscriptionIn: 3,
  gameeVer: 1,
  onboardingComplete: null,
  allRankings: {},
  gameLoaded: function () {
    var e = $("html"), a = $(".gameFrame");
    e.addClass("loaded"), gameeUI.startOverlay.show(), a.focus(), $(".relatedGames").length && (window.scroller4 = new Scroller("#overlay-end .relatedGames .scrollArea", scrollerConfigHorizontal)), window.scroller5 = new Scroller("#overlay-end .scrollerWrap", scrollerConfigVertical), "undefined" != typeof kik && kik.enabled && kik.getUser(function (e) {
  ...
  gameOver: function () {
    ...
    gameeUI.gameplayCount++, isTelegram() && gameGlobals.offerTelegramSubscription && gameeUI.gameplayCount % gameeUI.offerSubscriptionIn === 0 && gameeUI.subscribeDialog.show(), window.scroller5 && window.scroller5.scrollToTop(), $("#overlay-end .rankings, #overlay-end .ranks-wrap").removeClass("visible"), $(".share-tw").attr("href", gameeUI.game_tw_link(e)), gameeUI.currentState = "gameOver", gameeUI.highscoreBeat = !1, gameeUI.onboardingComplete = !0, gameeUI.setScoreCustomText(""), gameeUI.overlay.show(), gameeUI.controls.hide(), $(".rankingsFailed").hide(), setTimeout(function () {
      gameeUI.restartBtn.show()
    }, 500), gameeUI.saveScore(gameeUI.score), gameeUI.updateHighscore(gameeUI.score), isTelegram() || gameeUI.sendMixpanel(window.gameeUI.score), ga("send", {
      hitType: "event",
      eventCategory: "Game",
      eventAction: "Played",
      eventLabel: "" + gameGlobals.game_name
    }), gameeUI.timer.stop()
  },
  ...
  updateScore: function (e) {
    var a = $(".totalScore");
    gameeUI.score = e, a.html(parseInt(e))
  },
  ...
  sendMixpanelShare: function (e, a, t, n) {
  },
...
}), $(".subscribe-btn.on-telegram").on("click", function (e) {
  gameeUI.subscribeDialog.hide()
});
