...
(function (Penalty) {
    ...
    })(Penalty.eMobileOS || (Penalty.eMobileOS = {}));
    var eMobileOS = Penalty.eMobileOS;
    var Global = (function () {
        function Global() {
        }
        Global.init = function (game) {
            Global.game = game;
            if (Global.FB_INSTANT_GAME)
...
(function (FBInstantGame_1) {
    var FBInstantGame = (function () {
        ...
        Object.defineProperty(FBInstantGame.prototype, "score", {
            get: function () {
                return this._score;
            },
            set: function (score) {
                this._score = score;
                if (this._ready)
                    window.FBInstant.setScore(this._score);
            },
            enumerable: true,
            configurable: true
        });
        ...
        FBInstantGame.prototype.endGame = function (restartSignal) {
            ...
            if (this._ready) {
                window.FBInstant.endGameAsync().then(function () {
                    FBInstantGame.instance._score = 0;
                    FBInstantGame.instance._signal.dispatch();
                });
            }
        };
...
(function (Penalty) {
    var RemAttempts = (function () {
        function RemAttempts() {
            ...
            var img = Penalty.Global.game.cache.getImage("attemptFrame");
            this._iconSize = new Phaser.Point(img.width, img.height);
        ...
        RemAttempts.prototype.resize = function () {
            ...
            layer.position.set(camera.x + camera.width - layer.width, camera.y + 25);
        };
...
(function (Penalty) {
    ...
    var Ball = (function () {
        ...
        Ball.startPos = new Phaser.Point(320, 1035);
        return Ball;
    }());
    Penalty.Ball = Ball;
})(Penalty || (Penalty = {}));
...
(function (Penalty) {
    ...
    var KeeperSideJump = (function (_super) {
        ...
        function KeeperSideJump(playState) {
            _super.call(this, playState);
            this._startPos = new Phaser.Point();
            this._ballPos = new Phaser.Point();
            this._topPos = new Phaser.Point();
            this._lineFromStartPos = new Phaser.Line();
            this._lineFromBallPos = new Phaser.Line();
        }
...
(function (Penalty) {
    ...
    })(Penalty.eKeeperState || (Penalty.eKeeperState = {}));
    var eKeeperState = Penalty.eKeeperState;
    var Keeper = (function () {
...
(function (Penalty) {
    ...
    })(Penalty.eGoalTargetType || (Penalty.eGoalTargetType = {}));
    var eGoalTargetType = Penalty.eGoalTargetType;
    ;
    ...
    var GoalActTarget = (function (_super) {
        ...
        function GoalActTarget() {
            _super.call(this, Penalty.Global.game, 0, 0, "atlas0", "target");
            this._targetData = null;
            this._posA = new Phaser.Point();
            this._posB = new Phaser.Point();
...
(function (Penalty) {
    var Game = (function (_super) {
        ...
        function Game() {
            ...
            this.state.add("Boot", Penalty.Boot);
            this.state.add("Preload", Penalty.Preload);
            this.state.add("Play", Penalty.Play);
...
(function (Penalty) {
    ...
    })(Penalty.eKickOffResult || (Penalty.eKickOffResult = {}));
    var eKickOffResult = Penalty.eKickOffResult;
...
(function (Gamee2) {
    ...
    })(Gamee2.eInitState || (Gamee2.eInitState = {}));
    var eInitState = Gamee2.eInitState;
    var Gamee = (function () {
        function Gamee() {
        }
            ...
            if (Gamee._initState === eInitState.none) {
                ...
                window.gamee.gameInit(controller, {}, gameCapabilities, function (error, data) {
                    if (error === undefined || error === null) {
                        ...
                        if (gameCapabilities.indexOf("saveState") >= 0) {
                            if (data.saveState != undefined && data.saveState != null && typeof data.saveState == "string" && data.saveState.length != 0) {
                                try {
                                    Gamee.saveState = JSON.parse(data.saveState);
                                }
                                catch (e) {
                                }
                            }
        ...
        Gamee.gameSave = function () {
            if (Gamee._initState == eInitState.ok && Gamee._ready) {
                window.gamee.gameSave(Gamee.saveState);
            }
        };
...
(function (Penalty) {
    var Boot = (function (_super) {
        ...
        function Boot() {
            ...
            this._gameMinDims = new Phaser.Point(Penalty.Global.GAME_MIN_WIDTH, Penalty.Global.GAME_MIN_HEIGHT);
            this._gameMaxDims = new Phaser.Point(Penalty.Global.GAME_WIDTH, Penalty.Global.GAME_HEIGHT);
...
(function (Penalty) {
    ...
    })(Penalty.ePlayState || (Penalty.ePlayState = {}));
    var ePlayState = Penalty.ePlayState;
    var Play = (function (_super) {
        ...
        Play.prototype.create = function () {
            ...
            if (Penalty.Global.FB_INSTANT_GAME) {
                this._scoreBoard = new Utils.ScoreBoard(this.game, this.world);
            }
        ...
        Play.prototype.reset = function () {
            if (Penalty.Global.FB_INSTANT_GAME)
                this._scoreBoard.value = 0;
            else if (Penalty.Global.GAMEE)
                Gamee2.Gamee.score = 0;
        ...
        Play.prototype.resized = function (newGameW, newGameH, oldGameW, oldGameH) {
            ...
            camera.setPosition((Penalty.Global.GAME_WIDTH - newGameW) >> 1, Penalty.Global.GAME_HEIGHT - newGameH);
            camera.update();
            this._remAttempts.resize();
            if (Penalty.Global.FB_INSTANT_GAME)
                this._scoreBoard.position.set(camera.x + (camera.width / 2), camera.y + 40);
        };
        Play.prototype.onTargetHit = function (pos) {
            ...
            else if (Penalty.Global.FB_INSTANT_GAME) {
                this._scoreBoard.value = (FBInstantGame.FBInstantGame.instance.score += score);
            }
        ...
        Play.prototype.onRoundCompleted = function () {
            if (this._remAttempts.remAttampts == 0) {
                ...
                this.game.paused = true;
                if (Penalty.Global.GAMEE && Gamee2.Gamee.initialized) {
...
(function (Penalty) {
    var Preload = (function (_super) {
        ...
        Preload.prototype.preload = function () {
            ...
            if (Penalty.Global.FB_INSTANT_GAME)
                this.load.bitmapFont("fntScoreBoard");
            if (!this.game.device.webAudio) {
            ...
            if (Penalty.Global.GAMEE) {
                ...
                if (Gamee2.Gamee.initialize("FullScreen", [])) {
...
(function (Utils) {
    var ScoreBoard = (function (_super) {
        ...
        function ScoreBoard(game, parent) {
            ...
            var title = new Phaser.Image(game, 0, 0, "atlas0", "scoreTitle");
            title.anchor.set(0, 0.5);
            this.add(title);
            var scoreBg = new Phaser.Image(game, 0, 0, "atlas0", "scoreFrame");
            scoreBg.anchor.set(0.5, 0.5);
            this.add(scoreBg);
            var width = title.width + 10 + scoreBg.width;
            var half = Math.floor(width / 2);
            title.x = -half;
            scoreBg.x = title.x + title.width + 10 + scoreBg.width / 2;
            this._valueText = new Phaser.BitmapText(game, scoreBg.x, 0, "fntScoreBoard", "0", 28);
            this._valueText.anchor.set(0.5, 0.3);
            this.add(this._valueText);
        }
        Object.defineProperty(ScoreBoard.prototype, "value", {
            set: function (value) {
